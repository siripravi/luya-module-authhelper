            ...
            <div class="col-12 col-md-6 bsb-tpl-bg-platinum">
                <div class="d-flex flex-column justify-content-between h-100 p-3 p-md-4 p-xl-5">
                    ...
                    <?php if (FeatureHelper::isRegistrationEnabled()) : ?>
                        <p class="mb-0">
                            Not a member yet? ? <?= Html::a(Yii::t('user', 'Register now!'), ['/user/registration/register'], ['class' => 'link-secondary text-decoration-none']) ?>
                        </p>
                    <?php endif ?>
                </div>
            </div>
                            ...
                            <div class="d-flex">
                                <?php if ($module->enablePasswordRecovery) : ?>
                                    <?= Html::a(
                                        ...
                                        ['tabindex' => '5', 'class' => 'link-secondary text-decoration-none']
                                    ); ?>
                                <?php endif; ?>
                            </div>
