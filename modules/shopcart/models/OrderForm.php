...
class OrderForm extends \luya\forms\Model implements CartPositionInterface
{
    ...
    public function init()
    {
        ...
        $this->on(
            ...
            [
                new \app\modules\shopcart\BeforeLoadOrderFormHandler(),
                'handleBeforeLoad',
            ]
        );
        ...
        $this->on(
            ...
            [
                new \app\modules\shopcart\AfterSaveOrderFormHandler(),
                'handleAfterSave',
            ]
        );
    }
    ...
    {
        return \Yii::createObject(['class' => \app\modules\shopcart\AfterSaveOrderFormEvent::class, 'model' => $model]);
    }
    ...
    public static function getBeforeLoadModelEvent(\app\modules\shopcart\models\OrderForm $model)
    {
        return \Yii::createObject(['class' => \app\modules\shopcart\BeforeLoadOrderFormEvent::class, 'model' => $model]);
    }
}
