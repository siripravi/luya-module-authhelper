...
/* @var $model dench\shopshopshopcart\models\OrderProduct */
...
<div class="order-product-form">
    ...
    <?= $form->field($model, 'name')->widget(Typeahead::class, [
        ...
        'pluginEvents' => [
            'typeahead:select' => "function(ev, suggestion) { $('#orderproduct-article_id').val(suggestion.id); $('#orderproduct-price').val(suggestion.price); }",
        ],
    ]) ?>
