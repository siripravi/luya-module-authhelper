...
- `app\modules\user\helpers\Password` helper has been removed. If you need to generate password then use
 `app\modules\user\helpers\PasswordGenerator` helper instead. If you used it to hash and validate user's password, then
 use methods `hashPassword` and `validatePassword` of `app\modules\user\models\User`
