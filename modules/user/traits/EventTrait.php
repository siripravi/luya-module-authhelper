...
use app\modules\user\events\AuthEvent;
use app\modules\user\events\ConnectEvent;
use app\modules\user\events\FormEvent;
use app\modules\user\events\ProfileEvent;
use app\modules\user\events\ResetPasswordEvent;
