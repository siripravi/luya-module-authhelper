...
use app\modules\user\service\exceptions\InvalidTokenException;
use app\modules\user\service\exceptions\InvalidUserException;
use app\modules\user\events\RegistrationEvent;
use app\modules\user\events\UserEvent;
use app\modules\user\mail\RegistrationEmail;
