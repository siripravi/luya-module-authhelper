...
use chandra\user\service\exceptions\ServiceException;
use chandra\user\service\RegistrationService;
use chandra\user\service\ConfirmationService;
use chandra\user\models\Account;
use chandra\user\models\RegistrationForm;
use chandra\user\models\ResendForm;
use chandra\user\models\User;
use chandra\user\traits\AjaxValidationTrait;
use chandra\user\traits\EventTrait;
...
class RegistrationController extends Controller
{
     ...
     * Triggered with \chandra\user\events\FormEvent.
     */
     ...
     * Triggered with \chandra\user\events\UserEvent.
     */
