...
use Chandra\Yii2Account\models\UserSearch;
...
<?php if (FeatureHelper::isEmailConfirmationEnabled()): ?>
    <?= $form->field($searchModel, 'confirmStatus')->widget(ToggleButtonGroup::class, [
        'type' => 'radio',
...
<?php endif ?>
<?= $form->field($searchModel, 'blockStatus')->widget(ToggleButtonGroup::class, [
    'type' => 'radio',
    'items' => $searchModel->getBlockStatusList(),
    'labelOptions' => ['class' => 'btn-default'],
]) ?>
<?php if (FeatureHelper::isAdminApprovalEnabled()): ?>
    <?= $form->field($searchModel, 'approveStatus')->widget(ToggleButtonGroup::class, [
        'type' => 'radio',
