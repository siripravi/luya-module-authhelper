...
- `Chandra\Yii2Account\helpers\Password` helper has been removed. If you need to generate password then use
 `Chandra\Yii2Account\helpers\PasswordGenerator` helper instead. If you used it to hash and validate user's password, then
 use methods `hashPassword` and `validatePassword` of `Chandra\Yii2Account\models\User`
