...
namespace Chandra\Yii2Account\helpers;

use Chandra\Yii2Account\service\RegistrationService;
use Chandra\Yii2Account\service\ConfirmationService;
...
class FeatureHelper
{
    ...
    protected static function getConfirmationService()
    {
        if (static::$confirmationService === null) {
            static::$confirmationService = \Yii::createObject(ConfirmationService::class);
        }
    ...
    protected static function getRegistrationService()
    {
        if (static::$registrationService === null) {
            static::$registrationService = \Yii::createObject(RegistrationService::class);
        }
